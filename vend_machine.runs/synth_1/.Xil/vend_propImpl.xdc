set_property SRC_FILE_INFO {cfile:C:/Documents/Sophomore2/Digital_logic_and_digital_system/DLDS/docs/Experiments/Lab4/vend_machine/vend_machine.srcs/constrs_1/new/pin.xdc rfile:../../../vend_machine.srcs/constrs_1/new/pin.xdc id:1} [current_design]
...
set_property -dict { PACKAGE_PIN B9   IOSTANDARD LVCMOS33 } [get_ports { coin5 }];
set_property src_info {type:XDC file:1 line:9 export:INPUT save:INPUT read:READ} [current_design]
set_property -dict { PACKAGE_PIN D11  IOSTANDARD LVCMOS33 } [get_ports { coin10 }];
set_property src_info {type:XDC file:1 line:12 export:INPUT save:INPUT read:READ} [current_design]
set_property -dict { PACKAGE_PIN L14  IOSTANDARD LVCMOS33 } [get_ports { open }];
